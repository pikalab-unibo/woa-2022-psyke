...
In \Cref{fig:general-error} we report some examples of predictive errors measured for a generalised extractor.
%
The three plots follow the same logic as \Cref{fig:general-sim}.
%
\gcnote{Preferirei che spiegassi l'immagine}
...
\gcnote{Un esempio ci starebbe bene}
