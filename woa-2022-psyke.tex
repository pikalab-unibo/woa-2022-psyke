...
In the following a comparison between the hypercube-based SKE algorithms cited in \xs{experiments} -- namely \iter{} and \gridex{} -- is provided to give a practical demonstration of our methodology.
%
