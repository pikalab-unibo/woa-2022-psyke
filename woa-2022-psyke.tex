...
%
\Cref{sec:contribution} presents our meta-model for hypercube-based methods and compares most relevant methods from the litterature, which are then exemplified in \Cref{sec:experiments}.
%
...
\gcnote{Da qui in poi si può togliere, ma te lo lascio perchè magari buona parte di ste robe si spargono nel resto}
